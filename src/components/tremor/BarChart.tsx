...
import { ChevronLeft as RiArrowLeftSLine, ChevronRight as RiArrowRightSLine, X as RiCloseLine } from "lucide-react"
  ...
  return (
    ...
    >
      <button className="group inline-flex items-center gap-2">
        ...
        <RiCloseLine
          className="-ml-0.5 size-3.5 shrink-0 text-text-subtle group-hover:text-text"
          aria-hidden={true}
        />
      </button>
    </li>
