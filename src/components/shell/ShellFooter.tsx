...
export function ShellFooter() {
  return (
    <footer className="border-line text-ink-40 border-t px-5 py-7">
      <div className="mx-auto flex max-w-[1440px] flex-wrap items-center justify-between gap-x-8 gap-y-3 text-[13px] font-medium">
        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-0">
          ...
          <Link className="hover:text-ink inline-flex min-h-11 items-center px-1.5 transition-colors" to="/for-employers">
            For employers
          </Link>
          <Link className="hover:text-ink inline-flex min-h-11 items-center px-1.5 transition-colors" to="/privacy">
            Privacy
          </Link>
          <Link className="hover:text-ink inline-flex min-h-11 items-center px-1.5 transition-colors" to="/terms">
            Terms
          </Link>
          <a className="hover:text-ink inline-flex min-h-11 items-center px-1.5 transition-colors" href="mailto:hello@topfarms.co.nz">
