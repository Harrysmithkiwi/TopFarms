  ...
  return (
    <div className="space-y-3">
      ...
      <textarea
        ...
        className="bg-surface-2 border-border focus:border-brand max-h-[160px] min-h-[44px] w-full resize-none rounded-12 border-[1.5px] px-[14px] py-3 text-[15px] leading-6 focus:border-2"
        rows={2}
      />
