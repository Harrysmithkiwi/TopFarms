...
import { PasteCapture, inputCls } from '@/components/admin/PasteCapture'
...
// PasteCapture, its image helpers and `inputCls` moved to
// components/admin/PasteCapture.tsx when the seeker queue arrived — one capture
// surface feeds both queues, because lead-intake classifies the type itself.
