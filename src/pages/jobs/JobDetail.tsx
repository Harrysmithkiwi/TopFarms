 ...
 * - Visitors (not logged in): see full listing + sticky signup CTA bar
 * - Seekers: see full listing + "Apply Now" placeholder
      ...
      {isSeeker && (
        ...
        >
          <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-end gap-4">
            <button
              type="button"
              onClick={() => toast.info('Applications opening soon — stay tuned!')}
              className={cn(
                'font-body font-bold rounded-[8px] transition-all duration-200 inline-flex items-center justify-center',
                'bg-moss text-white hover:bg-fern',
