      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            className="font-body text-text placeholder:text-text-subtle bg-surface-2 focus-visible:outline-brand border-border focus:border-brand-hover w-full resize-none rounded-8 border-[1.5px] px-3 py-2 text-[13px] transition-colors duration-200 focus-visible:outline-2 focus-visible:outline-offset-2"
            rows={4}
