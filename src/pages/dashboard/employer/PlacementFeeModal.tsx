        ...
        >
          ...
          <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-fog">
            <div className="flex items-center gap-2">
              <Lock className="w-5 h-5 text-hay" />
              <h2
          ...
          <div className="px-6 py-5 space-y-6">
            {/* Candidate name */}
            <p className="text-[14px] font-body font-semibold" style={{ color: 'var(--color-ink)' }}>
              {candidateName}
            </p>
            ...
            <div className="space-y-2">
              <span
                ...
                style={{ backgroundColor: 'rgba(212,168,67,0.1)', color: 'var(--color-hay)' }}
              >
                {feeTierLabel}
              </span>
              <p className="text-[16px] font-body font-semibold" style={{ color: 'var(--color-ink)' }}>
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-2">
              <div>
                <span className="text-[11px] font-body" style={{ color: 'var(--color-light)' }}>Phone</span>
                <p className="font-mono text-[13px] select-none blur-sm" style={{ color: 'var(--color-mid)' }}>
                  ••• ••• ••••
                </p>
              </div>
              <div>
                <span className="text-[11px] font-body" style={{ color: 'var(--color-light)' }}>Email</span>
                <p className="font-mono text-[13px] select-none blur-sm" style={{ color: 'var(--color-mid)' }}>
                  j•••@gmail.com
                </p>
              </div>
