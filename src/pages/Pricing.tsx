    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--color-cream)' }}>
      ...
      <section className="py-20 px-4" style={{ backgroundColor: 'var(--color-soil)' }}>
        ...
        >
          ...
          <p className="text-lg" style={{ color: 'rgba(247,242,232,0.7)' }}>
      ...
      <section className="py-20 px-4" style={{ backgroundColor: 'var(--color-cream)' }}>
        <div className="max-w-5xl mx-auto">
              ...
              >
                {tier.isPopular && (
                  <div
                    ...
                    style={{ backgroundColor: 'var(--color-meadow)', color: 'var(--color-white)' }}
                  >
                    Most Popular
                  </div>
                )}
                <div className="p-7 flex-1">
                  <p className="font-display font-bold text-lg mb-1" style={{ color: 'var(--color-soil)' }}>
                    {tier.name}
                  </p>
                  ...
                  <div className="flex items-end gap-1 mb-6">
                    <span className="font-display font-bold text-4xl" style={{ color: 'var(--color-soil)' }}>
                      {tier.price}
                    </span>
                    <span className="text-sm pb-1" style={{ color: 'var(--color-mid)' }}>
                      {tier.period}
                    </span>
                  </div>
                  <ul className="flex flex-col gap-3">
                    {tier.features.map((f) => (
                      <li key={f} className="flex items-start gap-2.5">
                        ...
                        >
                          <Check size={10} style={{ color: 'var(--color-meadow)' }} strokeWidth={3} />
                        </span>
                ...
                <div className="px-7 pb-7">
                  <Link
                    ...
                    style={
                      tier.isPopular
                        ? { backgroundColor: 'var(--color-meadow)', color: 'var(--color-white)' }
                        : {
          ...
          <motion.div
            ...
            style={{ backgroundColor: 'rgba(122,175,63,0.1)', color: 'var(--color-soil)' }}
            initial={{ opacity: 0 }}
      ...
      <section className="py-20 px-4" style={{ backgroundColor: 'var(--color-white)' }}>
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col divide-y" style={{ borderColor: 'var(--color-fog)' }}>
            {faqs.map((faq, i) => (
              <motion.div
                key={faq.q}
                className="py-5"
              ...
              >
                <p className="font-semibold text-base mb-2" style={{ color: 'var(--color-soil)' }}>
                  {faq.q}
                </p>
