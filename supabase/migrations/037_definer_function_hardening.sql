...
REVOKE ALL ON FUNCTION public.admin_approve_document(uuid) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_get_daily_briefing() FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_get_system_alerts() FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_get_user_audit(uuid) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_get_user_profile(uuid) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_list_analytics_events(text, integer, integer) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_list_document_queue(integer, integer) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_list_employers(text, integer, integer) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_list_jobs(text, integer, integer) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_list_placements(integer, integer) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_list_seekers(text, integer, integer) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_reject_document(uuid, text) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_request_more_info(uuid) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_set_user_active(uuid, boolean) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.admin_skill_coverage() FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.compute_match_score(uuid, uuid) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.compute_match_scores_batch(uuid, uuid[]) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.estimate_match_pool(text, text[], boolean) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.get_adjacent_regions(text) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.get_applicants_for_job(uuid) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.mark_job_filled(uuid, uuid) FROM PUBLIC, anon;
...
REVOKE EXECUTE ON FUNCTION public._admin_gate() FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.handle_job_filled() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.rls_auto_enable() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.cleanup_match_scores_on_status_change() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.trigger_recompute_job_scores() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.trigger_recompute_seeker_scores() FROM PUBLIC, anon, authenticated;
...
-- Category A functions must KEEP authenticated access. Several only ever had
-- the implicit PUBLIC grant (pre-023 era), which the REVOKEs above remove —
-- so re-grant authenticated explicitly (idempotent where 016/018/023 already
-- did). DISCOVERED ON FIRST APPLY 2026-06-11: the original draft revoked
-- `FROM anon` only, a no-op against the implicit PUBLIC grant (anon inherits
-- PUBLIC) — advisor count stayed 32. This corrected version revokes PUBLIC.
...
GRANT EXECUTE ON FUNCTION public.admin_list_analytics_events(text, integer, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public.admin_list_document_queue(integer, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public.admin_list_employers(text, integer, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public.admin_list_jobs(text, integer, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public.admin_list_placements(integer, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public.admin_list_seekers(text, integer, integer) TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.compute_match_scores_batch(uuid, uuid[]) TO authenticated;
GRANT EXECUTE ON FUNCTION public.estimate_match_pool(text, text[], boolean) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_adjacent_regions(text) TO authenticated;
