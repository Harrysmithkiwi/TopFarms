...
- FOUND: `supabase/migrations/010_match_scores_precompute.sql`
- FOUND: `.planning/phases/04-match-scoring-engine/04-01-SUMMARY.md`
- FOUND commit: `65a0a3c` feat(04-01): add match_scores precompute migration
