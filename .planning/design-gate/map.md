...
**This map holds decisions only.** Wayfinder is plan-don't-do and that is not overridden here.
...
- **What evidence closes the gate for a portal.** The admin brief defines Gates B and C for
  admin; nothing defines them for the other two. May be answered by `05`/`06`, so not
  pre-sliced here.
