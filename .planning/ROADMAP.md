...
- [ ] 17-02-save-flow-PLAN.md — SaveSearchModal (RHF+Zod, inline role=alert) + ReplaceOldestModal (10-cap) + JobSearch Save button wiring (turns modal + cap tests GREEN)
- [ ] 17-03-list-page-PLAN.md — SavedSearches.tsx dashboard route (list + load + delete-with-undo + inline rename) + Sidebar nav + main.tsx route registration (turns list test GREEN)
...
| 17. Saved Search | 3/5 | In Progress|  | — |
