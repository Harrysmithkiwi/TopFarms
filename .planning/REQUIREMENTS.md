...
- [ ] **MAIL-01**: Resend sending domain has SPF and DKIM DNS records configured and verified for production email delivery. Code deployed; awaiting `RESEND_API_KEY` production secret + 15-02 E2E verification before satisfaction. Carryforward to post-Phase-15. (reset 2026-04-29 from `[x]` — Phase 13 missing VERIFICATION.md; partial-close note added 2026-05-01 via 13-VERIFICATION.md backfill; 2026-05-03 — placement_fees columns + cron + Resend infrastructure all confirmed in place after BLOCK 3 reconciliation; status unchanged per §7 — RESEND_API_KEY + 15-02 E2E still pending)
- [ ] **MAIL-02**: When employer marks a job as filled, all applicants with unresolved status (applied, reviewed, interview, shortlisted) receive an automated notification email. Code deployed and reachable. Trigger no longer 404s. Awaiting `RESEND_API_KEY` production secret + 15-02 E2E verification before satisfaction. Carryforward to post-Phase-15. (reset 2026-04-29 from `[x]` — `notify-job-filled` Edge Function not deployed live; partial-close note added 2026-05-01 via 13-VERIFICATION.md backfill; 2026-05-03 — placement_fees columns + cron + Resend infrastructure all confirmed in place after BLOCK 3 reconciliation; status unchanged per §7 — RESEND_API_KEY + 15-02 E2E still pending)
