...
must_haves:
  truths:
    - "Existing employer profiles load with accommodation_extras chips pre-populated via booleanColumnsToChipArray, so v1.0 users see their previous boolean selections as selected chips when re-opening the wizard"
